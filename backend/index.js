  ...
  try {
    ...
    for (const r of rows) {
      ...
      const qUpdate = `UPDATE leads_import SET
        created_at = $2,
        first_name = $3, last_name = $4, email = $5, phone = $6, address = $7, city = $8, pickup_city = $9,
        date_contacted = $10, date_handover = $11, model = $12, serial_number = $13, note = $14
        WHERE submission_id = $1 AND country_code = 'HR'`;
      const vals = [
        r.submission_id, r.created_at, r.first_name, r.last_name, r.email, r.phone, r.address, r.city, r.pickup_city,
      ...
      if (result === 0) {
        // Insert ako ne postoji
          const qInsert = `INSERT INTO leads_import (
            submission_id, country_code, created_at, first_name, last_name, email, phone, address, city, pickup_city,
